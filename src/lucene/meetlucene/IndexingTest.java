...
import lucene.meetlucene.util.TestUtil;
...
public class IndexingTest extends TestCase {
  ...
  public void testIndexWriter() throws IOException, ParseException {
    QueryParser queryParser = new QueryParser(Version.LUCENE_30,"a",new StandardAnalyzer(Version.LUCENE_30));
    System.out.println(queryParser.parse("java AND junit"));
